...
//             <div className="relative w-full flex-shrink-0 md:w-[300px] lg:w-[300px]">
//               <Filter
//                 className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500"
//                 size={18}
//               />
//               <select
//                 className="w-full cursor-pointer appearance-none overflow-hidden rounded-xl border border-gray-200 bg-white py-3 pl-11 pr-10 text-gray-600 shadow-sm transition-all focus:border-[#007A8A] focus:outline-none focus:ring-2 focus:ring-[#007A8A]/10"
      ...
      <div className="overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-sm">
        <div className="border-b border-gray-100 p-6">
          <div className="flex w-full flex-col gap-4 md:flex-row">
            ...
            {/* চ্যাপ্টার সিলেক্ট কন্টেইনার ফিক্স */}
            <div className="relative w-full flex-shrink-0 md:w-[320px] max-w-full">
              <Filter
                className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500"
                size={18}
              />
              <select
                className="w-full cursor-pointer appearance-none rounded-xl border border-gray-200 bg-white py-3 pl-11 pr-10 text-gray-600 shadow-sm transition-all focus:border-[#007A8A] focus:outline-none focus:ring-2 focus:ring-[#007A8A]/10 truncate"
                value={filterChapterId}
                onChange={(event) => {
                  setFilterChapterId(event.target.value);
                  setCurrentPage(1);
              ...
              >
                <option value="">All Chapters</option>
                {chapters.map((chapter: any) => (
                  <option key={chapter.id} value={chapter.id} className="truncate">
                    Chapter {chapter.number}: {chapter.title}
                  </option>
                ))}
              </select>
          ...
          {(searchTerm || filterChapterId) && (
            <div className="mt-4 flex flex-wrap gap-2 pt-2">
              ...
              {selectedChapter && (
                <span className="flex items-center gap-2 rounded-lg bg-green-50 px-3 py-1.5 text-sm text-green-700 max-w-full">
                  ...
                  <button
                    onClick={() => setFilterChapterId("")}
                    className="ml-1 font-bold hover:text-green-900 flex-shrink-0"
                  >
                    x
                  </button>
                </span>
